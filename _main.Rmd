--- 
title: "Systemic and mucosal immune response of Nile tilapia to monovalent and bivalent vaccines against Streptococcus agalactiae and Aeromonas veronii"   
...
#### High level view (for vaccination)
...
<br/>
```{r, fig.cap="Experimental design for vaccination (high level)", echo=FALSE, out.width='\\textwidth'}
knitr::include_graphics("vaccination-high.png")
```

#### Low level view (for vaccination)
...
<br/>
```{r, fig.cap="Experimental design for vaccination (low level)", echo=FALSE , out.width='\\textwidth'}
...
<br/>
```{r, fig.cap="Experimental design for sampling (high level)", echo=FALSE , out.width='\\textwidth'}
knitr::include_graphics("sampling-high.png")
```

#### Low level view (for sampling)
...
<br/>
```{r, fig.cap="Experimental design for sampling (low level)", echo=FALSE, out.width='\\textwidth'}
...
<!--chapter:end:02-bacterialisolation.Rmd-->
...
<!--chapter:end:03-bacterialculture.Rmd-->
...
<!--chapter:end:04-samplingimmunization.Rmd-->
