...
*Details about the experiment:*
 ...
 - How much beneficial can be the vaccination for aquaculture?<br/>
 ...
 - When? <br/>
 - What are the majors risks and challenges?<br/>
 - Is the experiment reproducible?, what are the limitations? <br/>
 
# Project organisation

Objectives: Study of the immune response to formalin killed vaccines and their efficiencies. 
...
## Workflow 
```{r echo=FALSE, fig.height=60}
knitr::include_graphics("workflow3-1.png")
```
...
knitr::include_graphics("Split-Plot-Design-High-1.png")
```


```{r, fig.cap=c("your caption"), echo=FALSE}
knitr::include_graphics("Split-Plot-Design-Low-1.png")
```
